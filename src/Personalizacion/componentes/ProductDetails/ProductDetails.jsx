    ...
    <div className="bg-white">
      <div className="pt-6">
        ...
        <section className='grid grid-cols-1 lg:grid-cols-2 gap-x-8 gap-y-10 px4 pt-10'>
          ...
          {/* Product info */}
          <div className="lg:col-span-1 maxt-auto max-w-2x1 px-4 pb-16 sm:px-6 lg:max-w-7x1 lg:px-8
        lg:pb-24">
            <div className="lg:col-span-2">
              <h2 className="text-lg lg:text-xl font-semibold text-gray-900">Universal Outfit</h2>
              <h2 className='text-lg lg:text-xl text-gray-900 opacity-60 pt-1'>
                Casual puff sleeves Solid Women White To
              </h2>
            </div>
